...
bf16 = False
fp16 = True
model_name_long ="meta-llama/Llama-3.2-3B-Instruct" 
...
prompt ="""
Write a code snippet in pytorch for a N layered neural net that takes in an array of N floats and provides a float out as value
"""
prompt_template = create_prompt(prompt,"You are an expert programmer.")
gpt_gen(tokenizer, model, prompt_template,device)